CREATE TABLE [dbo].['2019$'_xlnm#Print_Titles] (
    [Country]                          NVARCHAR (255) NULL,
    [Year]                             NVARCHAR (255) NULL,
    [Rank]                             NVARCHAR (255) NULL,
    [Total]                            NVARCHAR (255) NULL,
    [C1: Security Apparatus]           NVARCHAR (255) NULL,
    [C2: Factionalized Elites]         NVARCHAR (255) NULL,
    [C3: Group Grievance]              NVARCHAR (255) NULL,
    [E1: Economy]                      NVARCHAR (255) NULL,
    [E2: Economic Inequality]          NVARCHAR (255) NULL,
    [E3: Human Flight and Brain Drain] NVARCHAR (255) NULL,
    [P1: State Legitimacy]             NVARCHAR (255) NULL,
    [P2: Public Services]              NVARCHAR (255) NULL,
    [P3: Human Rights]                 NVARCHAR (255) NULL,
    [S1: Demographic Pressures]        NVARCHAR (255) NULL,
    [S2: Refugees and IDPs]            NVARCHAR (255) NULL,
    [X1: External Intervention]        NVARCHAR (255) NULL,
    [Change from Previous Year]        NVARCHAR (255) NULL,
